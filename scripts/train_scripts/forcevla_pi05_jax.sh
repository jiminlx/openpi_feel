#!/bin/bash
#SBATCH --job-name=pi05_forcevla_jax_gripper_tactile_4tasks
...
CKPT_NAME="pi05_forcevla_jax_gripper_tactile_4tasks"
CKPT_PATH="/sjw_alinlab2/home/myungkyu/workspace/TactileVLA/TactilePi05/ckpt/tactile_vla/$CKPT_NAME"

XLA_PYTHON_CLIENT_MEM_FRACTION=0.9 uv run scripts/train.py forcevla_pi05_gripper_tactile \
    --exp-name=$CKPT_NAME \
    --batch-size=16 \
    --num-workers=12 \
    --save-interval=10000 \
