#!/bin/bash
#SBATCH --job-name=pi05_forcevla_pytorch_gripper_tactile_4tasks
...
CKPT_NAME="pi05_forcevla_pytorch_gripper_tactile_4tasks"
CKPT_PATH="/sjw_alinlab2/home/myungkyu/workspace/TactileVLA/TactilePi05/ckpt/tactile_vla/$CKPT_NAME"

uv run scripts/train_pytorch.py forcevla_pi05_gripper_tactile \
    --exp_name $CKPT_NAME \
    --batch_size 16 \
    --num_workers 12 \
    --save_interval 10000 \
