...
class PaliGemmaWithExpertAndFrankaTorqueModel(nn.Module):
    def __init__(
        self,
        vlm_config,
        ...
        torque_expert_config_hf = CONFIG_MAPPING["gemma"](
            ...
            torch_dtype="float32",
            use_adarms=use_adarms[1], # Index 1 for Torque
    ...
    def forward(
        ...
        # inputs_embeds = [vlm_emb, torque_emb, action_emb]
        if adarms_cond is None:
            adarms_cond = [None, None, None]
        
        # Models: [VLM, Torque, Action]
        models = [self.paligemma.language_model, self.torque_expert.model, self.gemma_expert.model]
        ...
        def compute_layer_complete(layer_idx, inputs_embeds, attention_mask, position_ids, adarms_cond):
            # inputs_embeds : [Tensor(VLM), Tensor(Torque), Tensor(Action)] list
            ...
            outputs_embeds = []
            start_pos = 0
            valid_idx = 0 # for valid modality index 
